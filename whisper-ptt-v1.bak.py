...
# Hotkey
# Use `keyboard.Key.ctrl_l`, `keyboard.Key.alt_l`, etc.
HOTKEY: Final[keyboard.Key] = keyboard.Key.ctrl_l
...
class WhisperPTT:
    ...
    def _on_press(self, key: keyboard.Key | keyboard.KeyCode | None) -> None:
        ...
        if key == HOTKEY and not self.is_capturing:
            with self._lock:
    ...
    def _on_release(self, key: keyboard.Key | keyboard.KeyCode | None) -> None:
        ...
        if key == HOTKEY and self.is_capturing:
            with self._lock:
    ...
    def run(self) -> None:
        ...
        with keyboard.Listener(on_press=self._on_press, on_release=self._on_release) as listener:
            print(f"PTT is running. Hold '{str(HOTKEY)}' to talk. Press Ctrl+C to exit.")
